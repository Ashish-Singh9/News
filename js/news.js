//ec3c16c75f5510694ad684341642a8df
const searchNews=document.getElementById('searchBar');
function f(){

fetch('https://gnews.io/api/v4/top-headlines?country=in&lang=en&token=ec3c16c75f5510694ad684341642a8df')
...
let news={
    ...
    fetchNews:function(search){
        fetch(`https://gnews.io/api/v4/search?q=${search}&token=ec3c16c75f5510694ad684341642a8df&lang=en`)
        .then(function (response) {
            return response.json();
        })
        .then(function (data) {
